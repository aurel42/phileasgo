...
export interface POIBeaconProps {
    color: string;
    size: number;
    showHalo?: boolean;
    activeBoost?: number;
...
/**
 * POIBeacon Component
 * Renders a calligraphic balloon at a specific coordinate with a dynamic vertical offset.
 */
export const POIBeacon: React.FC<POIBeaconProps> = ({
    color,
    size,
    showHalo = true,
    zoomScale = 1,
