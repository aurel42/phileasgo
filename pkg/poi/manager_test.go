...
func (s *MockStore) GetGeodataCache(ctx context.Context, key string) ([]byte, float64, bool) {
	return nil, 0, false
}
func (s *MockStore) SetGeodataCache(ctx context.Context, key string, val []byte, radius float64) error {
	return nil
}
