...
func TestOrchestrator_QueueManagement(t *testing.T) {
	...
	o := NewOrchestrator(mockGen, &MockAudio{}, pbQ, sess, nil, nil, nil, nil)
...
func TestAIService_RecordNarration(t *testing.T) {
	...
	svc.promptAssembler = prompt.NewAssembler(svc.cfg, nil, pm, nil, nil, nil, mockLLM, nil, nil, nil, nil, nil, nil)
