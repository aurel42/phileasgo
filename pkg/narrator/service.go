...
type Service interface {
	...
	// CurrentDuration returns the total duration of the current narrative.
...
// CurrentDuration returns the duration (stub: 0).
func (s *StubService) CurrentDuration() time.Duration {
	return 0
}
